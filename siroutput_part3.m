...
function f = siroutput_part3(x,t,data)
...
%We want actual and modeled cases, along with actual and modeled
%deaths.
...
cost=sum((ModeledCases-ActualCases).^2)+45*sum((ModeledDeaths-ActualDeaths).^2);
