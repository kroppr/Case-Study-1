...
%% Model each segment
%This section takes each individual identified segment and runs fmincon on
%it, the results are then combined to produce a better fit line
...
%This section expands upon the section above, by making it easy to modify
%for "Plans" and allows for seperate plotting. This data will appear in
%figures 5 and 6 as "New Modeled ..."
%The modification is simple, we need to reduce deaths and cases by 75%, we
%can apply a 0.75 multiplier across the segments to get our results
...
x_new_5_1(1)= x1(1)*0.75;
%Adjust fatality rate
x_new_5_1(2) = x1(2)*0.75;
